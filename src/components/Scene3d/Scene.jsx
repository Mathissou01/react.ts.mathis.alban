...
import { data as fragmentsShaderData } from "./utils/fragments-shader";
...
export default function Scene() {
   ...
   */
  const { nodes } = useGLTF("../public/models/scene.glb");
  ...
  const [
    ...
    "../public/models/textures/ground.png",
    "../public/models/textures/ground2.png",
    "../public/models/textures/ground_debris.png",
    "../public/models/textures/pipes_and_rover.png",
    "../public/models/textures/astronauts_white.png",
    "../public/models/textures/astronauts_orange.png",
    "../public/models/textures/fragments.png",
    "../public/models/textures/debris.png",
  ]);
